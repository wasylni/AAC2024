...
class D7Test {
    ...
    void t2() {
        ...
        Assertions.assertEquals(348360680516005l, result);
    }

    @Test
    void calculateTest() {
        D7 d7 = new D7();
        String equation1 = "3+3*10";
        Assertions.assertEquals(60, D7.evaluateEquation(equation1));

        String equation2 = "3+5*2";
        Assertions.assertEquals(16, D7.evaluateEquation(equation2));


        String equation3 = "10*12+3+5*2";
        Assertions.assertEquals(256, D7.evaluateEquation(equation3));


        String equation4 = "100||8||1*10||1||8+2";// = 10081020";
        Assertions.assertEquals(10081020, D7.evaluateEquationWithJoin(equation4));

        //        761||8||82*30||7||8+19||8+57 = 761264601035 NOT matches sum: 3692749373496
        String equation5 = "761||8||82*30||7||8+19||8+57";
        Assertions.assertEquals(22856461035l, D7.evaluateEquationWithJoin(equation5));
    }
...
//        D7 d7 = new D7();
//        String equation1 = "3+3*10";
//        Assertions.assertEquals(33, d7.evaluateEquation(equation1));
//
//        String equation2 = "3+5*2";
//        Assertions.assertEquals(13, d7.evaluateEquation(equation2));
//
//        String equation3 = "10*12+3+5*2";
//        Assertions.assertEquals(133, d7.evaluateEquation(equation3));
//    }


    String inputTest = "190: 10 19\n" +
            "3267: 81 40 27\n" +
            "83: 17 5\n" +
            "156: 15 6\n" +
            "7290: 6 8 6 15\n" +
